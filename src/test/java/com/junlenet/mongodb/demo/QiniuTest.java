...
public class QiniuTest {
    ...
    public static String uploadToQiNiuVedio(String path ,String filename, int days){
        //构造一个带指定Zone对象的配置类
        Configuration cfg = new Configuration(Zone.zone1());
        //...其他参数参考类注释
        ...
        UploadManager uploadManager = new UploadManager(cfg);
        //...生成上传凭证，然后准备上传
        String accessKey = "MddJO0GxZAEdJY85hnPfj3xAif0W2RoomU8CwNd5";
        String secretKey = "1TJoAc1HAkQY9Yd9kxr30F-QS6_Wq665Tu8umI6V";
        String bucket = "ladapp";
        String localFilePath = path+filename;
        String pathStr[] = path.split("/");
        String key = pathStr[pathStr.length-1]+"-"+filename;
