...
public enum ERRORCODE {
	...
	ORGANIZATION_USER_EXIST(100003, "该用户已经申请加入了此群"),
	ORGANIZATION_NOT_MASTER(100004, "非群主不能操作"),
	ORGANIZATION_IS_SELF(100005, "群主不能转给自己"),
	ORGANIZATION_USER_NULL(100006, "该用户不在此群组"),
	ORGANIZATION_MAX(100007, "群组创建已达到上限"),
	ORGANIZATION_USER_MAX(100008, "群组成员已达到上限"),
