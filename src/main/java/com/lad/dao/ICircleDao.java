...
public interface ICircleDao extends IBaseDao {
	...
	public CircleBo updateUsersApply(String circleBoId, HashSet<String> usersApply);
	public CircleBo updateUsersRefuse(String circleBoId, HashSet<String> usersRefuse);
	public CircleBo updateOrganizations(String circleBoId, HashSet<String> organizations);
